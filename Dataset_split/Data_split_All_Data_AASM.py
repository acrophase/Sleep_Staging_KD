...
def argparsing():
    ...
    parser.add_argument("--save_path", default="/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Inversion_Implemented_PTFiles/4_class/AASM/", help= 'Enter path to save files')
