...
class MassDataset(Dataset):
    def  __init__(
        ...
        while loop_iter in range(len(self.eeg_trainc3a2)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/EEG/train/eeg_train_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.ecg_train2)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/ECG/train/ecg_train_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.slp_stg_train)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/Sleep_stages/train/slp_stg_train_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.eeg_valc3a2)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/EEG/val/eeg_val_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.ecg_val2)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/ECG/val/ecg_val_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.slp_stg_val)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/Sleep_stages/val/slp_stg_val_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.eeg_testc3a2)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/EEG/test/eeg_test_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.ecg_test2)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/ECG/test/ecg_test_batch_"+str(file_iter)+".csv", index = False, header = False)
        ...
        while loop_iter in range(len(self.slp_stg_test)-self.batch_size):
            ...
            array_batch.to_csv("/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/Batchwise_Data/4_class/RK/Sleep_stages/test/slp_stg_test_batch_"+str(file_iter)+".csv", index = False, header = False)            
