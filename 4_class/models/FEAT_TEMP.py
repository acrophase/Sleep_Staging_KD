...
class AT_SD_CL_model(LightningModule):
    def __init__(
        self,
        filters=None,
        in_channels=None,
        ...
        **kwargs
        ...
        ## Loading ECG feature pretrained model
    ...
    def training_step(self, batch_train, batch_idx):
        ...
        train_Temp_loss_ecg, train_loss_ecg, pred_train_eeg, pred_train_ecg, y_train = self.compute_loss(pred_train_eeg, feature_list_eeg, pred_train_ecg, feature_list_ecg, y_train, class_weights)
        ...
        return {
            'loss':train_Temp_loss_ecg,  #### CONSIDERS CE LOSS ONLY FOR KD
    ...
    def validation_step(self, batch_eval, batch_idx):
        ...
        val_Temp_loss_ecg, val_loss_ecg, pred_val_eeg, pred_val_ecg, y_val = self.compute_loss(pred_val_eeg, feature_list_eeg, pred_val_ecg, feature_list_ecg, y_val, class_weights)
    ...
    def test_step(self, batch_test, batch_idx):
        ...
        test_Temp_loss_ecg, test_loss_ecg, pred_test_eeg, pred_test_ecg, y_test = self.compute_loss(pred_test_eeg, feature_list_eeg,  pred_test_ecg, feature_list_ecg, y_test, class_weights)
    ...
    def compute_loss(self, y_pred_eeg, y_feature_list_eeg, y_pred_ecg, y_feature_list_ecg, y_true, class_weights):
        ...
        return Temp_loss_ecg, loss_ecg, y_pred_eeg, y_pred_ecg, y_true
    ...
    def add_model_specific_args(parent_parser):
        ...
        architecture_group.add_argument("--feat_path", default='/media/Sentinel_2/Pose2/Vaibhav/MASS_CODE/Sleep_Joint_Learning/POCT/lightning_logs/version_74/checkpoints/Feature_Training_ALLDATA30s_epoch=81-val_Feature_Loss=0.02929.ckpt', help= 'Enter checkpoint path to trained features from Feature_Training')
...
if __name__ == "__main__":
    ...
    parser = AT_SD_CL_model.add_model_specific_args(parser)
    args = parser.parse_args()

    utime =AT_SD_CL_model(vars(args))