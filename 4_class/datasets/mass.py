...
class MassDataModule(pl.LightningDataModule):
    ...
    def add_dataset_specific_args(parent_parser):
        ...
        dataset_group.add_argument("--aasm_data_dir", default="/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/eeg_ecg_1ch_subjectwisesplit/4class/ALL_DATA/AASM/", help= 'Enter path to AASM data PT files')
        dataset_group.add_argument("--rk_data_dir", default="/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/eeg_ecg_1ch_subjectwisesplit/4class/ALL_DATA/R_K/30s/", help= 'Enter path to R_K data PT files')
...
if __name__ == "__main__":
    ...
    dm_params = dict(
        batch_size=256,
        aasm_data_dir='/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/eeg_ecg_1ch_subjectwisesplit/4class/ALL_DATA/AASM/',
        rk_data_dir='/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/eeg_ecg_1ch_subjectwisesplit/4class/ALL_DATA/R_K/30s/',
        n_workers=32,
    )
