...
class MassDataModule(pl.LightningDataModule):
    ...
    def add_dataset_specific_args(parent_parser):
        ...
        dataset_group.add_argument("--aasm_data_dir", default="/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/POCT/4_class/AASM/", help= 'Enter path to data PT files')
        dataset_group.add_argument("--rk_data_dir", default="/media/Sentinel_2/Dataset/Vaibhav/MASS/PT_FILES/POCT/4_class/R_K_30s/", help= 'Enter path to data PT files')
